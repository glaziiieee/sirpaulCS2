...
// Collections Paths in Firebase Cloud DB
const MAJOR_DESTINATION_COLLECTION = 'emigrantData/majorDestination/years'
const ALL_DESTINATION_COLLECTION = 'emigrantData/allDestination/years'
